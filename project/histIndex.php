...
$result1 = mysql_query("SELECT * FROM $ticker");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <ul class="breadcrumb">
							...
							<li><a href="getHistoricData.php">Historic Data</a>
                            </li>
                        </ul>
            ...
            <div class="container">
			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9" id="customer-orders">
						...
						<p class="text-muted lead"><h1><strong><?php echo $_SESSION["ticker"]."'s Historic Details";?></strong></h1></p>
                        <div class="box">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
									  ...
									  <?php
										...
										<td><?php echo $row1["open"]; ?></td>
										<td><?php echo $row1["high"]; ?></td>
										<td><?php echo $row1["low"]; ?></td>
										<td><?php echo $row1["close"]; ?></td>
										<td><?php echo $row1["volume"]; ?></td>
										<td><?php echo $row1["amount_change"]; ?></td>
										<td><?php echo $row1["percent_change"]; ?></td>
										</tr>
										<?php
										$i++;
										}
                        ...
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active">
                                        <a href="getQuotes.php"><i class="fa fa-list"></i>Get Real Time Quotes</a>
                                    </li>
                                    <li>
                                        <a href="getGraph.php"><i class="fa fa-heart"></i> View Graphical Data</a>
                                    </li>
                                    <li>
                                        <a href="getPrediction.php"><i class="fa fa-user"></i> Get Next Day Prediction</a>
                                    </li>
                                </ul>
                            </div>
