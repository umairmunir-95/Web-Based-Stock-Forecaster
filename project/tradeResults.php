...
?>
<?php 
$fetchQuery5="SELECT max(id) FROM tradingpolicies where isComplete=0 && userName='".$_SESSION['userName']."'";
$result5 = mysql_query($fetchQuery5);
$i=0;
...
$fetchQuery6="SELECT remainingTime FROM tradingpolicies where isComplete='0' && userName='".$_SESSION['userName']."' && id=".$_SESSION['maxID'];
$result6= mysql_query($fetchQuery6);
while($row6 = mysql_fetch_array($result6))
{
	$remainingTime=$row6["remainingTime"];
	$_SESSION['reTime']=$remainingTime;
	$i++;
}
...
else
{
	...
	while($row2 = mysql_fetch_array($result2))
	{
		...
		$unitPriceProfit=((($_SESSION['value']/100)*$unitPrice)+($unitPrice));
		$unitPriceLoss=(($unitPrice)-(($_SESSION['value']/100)*$unitPrice));
				   ...
				   <div class="col-md-9" id="customer-orders">
						...
						<div class="row">
						 ...
						 <div class="table-responsive">
                                    ...
                                    <tbody>
									    <tr>
										   ...
										   <?php
											...
											echo '<td>'.'<a href="tradeResults2.php?id='.$row1["id"].'" class="btn btn-template-main btn-sm">View </a>'.'</tr>';
											?>
											<?php
											$i++;
											}
							...
							<li><a href="tradeCalculation.php">If nothing happens, then click here...</a>
