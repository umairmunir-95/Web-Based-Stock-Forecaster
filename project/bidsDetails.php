			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9" id="customer-orders">
                        ...
                        <div class="row">
							...
							<div class="heading">
								<h2>My Bids Details</h2>
							</div>
                            <!-- /.col-md-6 -->

                           <div class="tabs">
                            <ul class="nav nav-pills nav-justified">
                                <li class=""><a href="#tab2-2" data-toggle="tab">Selling Bids</a>
                                </li>
                                <li class="active"><a href="#tab2-3" data-toggle="tab">Buying Bids</a>
                                </li>
                            </ul>
                            <div class="tab-content tab-content-inverse">
                                ...
                                <div class="tab-pane" id="tab2-2">
										 ...
										 <p>
												...
												<?php
													$fetchQuery="SELECT * FROM bids where sellerName='".$_SESSION['userName']."' && bidType='sell'";
													$result1 = mysql_query($fetchQuery);
													
													$i=0;
													while($row1 = mysql_fetch_array($result1))
													{
														$sql = "SELECT COUNT(ticker) as requestCount FROM bidsDetails where ticker='".$row1["ticker"]."'";
														...
														<td><?php echo $row1["sellerPrice"]; ?></td>
														<td><?php echo $row1["volume"]; ?></td>
														<td><?php if($row1["isComplete"]==0)echo 'Pending';else echo 'Completed'; ?></td>
														<td><?php echo $requests; ?></td>
														<td><?php echo '<a href=bidsDetailsView.php?id='.$row1["id"].'>View</a>';?></td>
														<td><?php echo '<a href=removeBid.php?id='.$row1["ticker"].'>Remove</a>';?></td>
														</tr>
														<?php
														$i++;
														}
                                ...
                                <div class="tab-pane active" id="tab2-3">
										...
										<p>
												...
												<tbody>
												<?php
												$fetchQuery2="SELECT * FROM bids where bidType='sell' && sellerName!='".$_SESSION['userName']."'";
												...
												$i=0;
													while($row1 = mysql_fetch_array($result2))
													{
														...
														<td><?php echo $row1["ticker"]; ?></td>
														<td><?php echo $row1["sellerPrice"];?></td>
														<td><?php echo '<input type="text" name="buyerPrice" title="This will be the price of your bid." maxlength="4" size="4">';?><td>
														<td><?php echo '<input type="text" name="volume" title="You can bid on maximum of '.$row1["volume"].' shares." maxlength="4" size="4">';?><td>
														<td><?php $id=$row1['id'];echo '<button type="submit" name="submit" value="Plan" class="btn btn-template-main">Submit</button>'.' | <a class="btn btn-template-main" href=addBid.php?id='.$id.'>Proceed</a> ';?><td>
														

													</form>
										   		</tr>
														<?php
														if(isSet($_POST['buyerPrice']) && isSet($_POST['buyerPrice']) ) 
														{
															$buyerPrice=$_POST['buyerPrice'];
															$volume=$_POST['volume'];
															$_SESSION['bp']=$buyerPrice;
															$_SESSION['v']=$volume;
															//$_SESSION['id']=$row1["id"];
