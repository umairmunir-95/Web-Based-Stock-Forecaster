...
session_start();
$fetchQuery="SELECT * FROM results";
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <ul class="breadcrumb">
							...
							<li><a href="getPrediction.php">Get Prediction</a>
                            </li>
                            <li>Results</li>
                        </ul>
        ...
        <div id="content">
			...
			<div class="panel-group" id="accordion">
                                    ...
                                    <div id="faq1" class="panel-collapse collapse">
                                        <div class="panel-body">
											<ul>
												...
												<html>
													<img src="pieGrahp.php" height="400" width="600"/>
												</html>
												</div>
											</ul>
			 ...
			 _________________________________________________________ -->
				   ...
				   <div class="col-md-20" id="customer-orders">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>RSI</th><th></th>
                                            <th>MA</th><th></th>
                                           <?php //paste here william %?>

										   <th>PMO</th><th></th>
											
                                            <th>Stochastic Oscilator</th><th></th>
											
											<th>System Prediction</th>
											<th>Actual Change</th><th></th><th></th>
											<th>Overal Status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
									    <tr>
											<?php
												...
												{
											?>
											<td><?php echo '<strong>'.$row1["ticker"].'</strong>';  ?></td>
											<td><?php echo '<strong>'.$row1["date"].'</strong>';  ?></td>
											<td><?php 
											if($row1["mfi"]=='decrease')
													echo '<td><span class="label label-danger">decrease</span>';
												else
													echo '<td><span class="label label-info">increase</span>';
											?></td>
											<td><?php 
												if($row1["rsi"]=='decrease')
													echo '<td><span class="label label-danger">decrease</span>';
												else
													echo '<td><span class="label label-info">increase</span>';
											...
											<td><?php 
												if($row1["prediction"]=='BUY')
													echo '<td><span class="label label-info">BUY</span>';
												else
													echo '<td><span class="label label-warning">SELL</span>';

											?></td>
											<td><?php 
												if($row1["actual"]<0 && $row1["actual"]=='-1000' )
													echo '<strong>'.'<font color="brown">'.'Record not found'.'</font>'.'</strong>';
												else if($row1["actual"]<'0' && $row1["actual"]!='-1000')
													echo '<strong>'.'<font color="red">'.number_format(($row1["actual"]),2).'</font>'.'</strong>';
												else
													echo '<strong>'.'<font color="green">'.number_format(($row1["actual"]),2).'</font>'.'</strong>';
											...
											<td><?php 
												if($row1["result"]=='0')
													echo '<td><span class="label label-warning">Failure</span>';
												else if($row1["result"]=='-1')
													echo '<td><span class="label label-info">Pending</span>';
												else
													echo '<td><span class="label label-success">Success</span>';
											?></tr>
