                    ...
                    <div class="homepage owl-carousel">
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="img/home3.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7 text-center">
                                    <img class="img-responsive" src="img/home2.png" alt="">
                                </div>
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="img/home5.png" alt="">
                                </div>
                                <div class="col-sm-5">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box-simple">
                                ...
                                <p>Get real time quotes of stock.</p>
							</div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-simple">
                                ...
                                <p>Get historic prices of registered companies.</p>
							</div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-simple">
                                ...
                                <p>View transactions and prices graphically.</p>
							</div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box-simple">
                                ...
                                <p>Get prediction of upcoming stock using our generic algorithmic calculation.</p>
							</div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-simple">
                                ...
                                <h3>Trading</h3>
                                <p>Buy/Sell stocks for real time practice in a virtual environment.</p>
							</div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-simple">
                                ...
                                <h3>Bids</h3>
                                <p>Add new bids to perform transactions.<p>
							</div>
                        </div>
                    </div>
                </div>
