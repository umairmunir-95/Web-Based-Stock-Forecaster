...
session_start();		
$id=$_GET["id"];
$fetchQuery="SELECT * FROM bids where id=".$id;
$result1 = mysql_query($fetchQuery);
$i=0;
while($row1 = mysql_fetch_array($result1))
{
	$_SESSION['sellerName']=$row1["sellerName"];
	$_SESSION['sellerPrice']=$row1["sellerPrice"];
	$_SESSION['volume']=$row1["volume"];
	$_SESSION['tiker']=$row1["ticker"];
}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo 'Company Ticker : '.$_SESSION['tiker'];?></h4>
            </div>
            <div class="modal-body">
			     <form action="" method="post">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_old">Seller Name</label>
											 <input type="text" name="ticker" class="form-control" value=<?php echo $_SESSION['sellerName'];?> readonly>
									    </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_1">Seller Price</label>
											
											 <input type="text" name="ticker" class="form-control" value=<?php echo $_SESSION['sellerPrice'];?> readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_2">Available Stock</label>
											 <input type="text" name="ticker" class="form-control" value=<?php echo $_SESSION['volume'];?> readonly>
										</div>
                                    </div>
                                </div>
                                <!-- /.row -->
								...
								$fetchQuery2="SELECT * FROM bidsDetails where ticker='".$_SESSION['tiker']."'";
								$result2 = mysql_query($fetchQuery2);
								$i=0;
								while($row2 = mysql_fetch_array($result2))
								{
									$_SESSION['buyerName']=$row2["buyerName"];
									$_SESSION['buyerPrice']=$row2["buyerPrice"];
									$_SESSION['buyervolume']=$row2["volume"];
									echo '<td>'.$_SESSION['buyerName'].'</td>';
									echo '<td>'.$_SESSION['buyerPrice'].'</td>';
									echo '<td>'.$_SESSION['buyervolume'].'</td>';
									echo '<td><a href=sellBid.php?id='.$_SESSION['buyerName'].' onclick="return confirm(Are you sure?)" >Sell</a></td></tr>';
                                    ...
                                    $j=$i+1;
                                    echo '<label>'.$j.'</label>';
									echo '<input type="text" name="ticker" class="form-control" value="'.$_SESSION['buyerName'].'" readonly>';
									echo '</div>';
                                    echo '</div>';
                                    echo '</div>';
									...
									echo '<div class="col-sm-6">';
                                    echo ' <div class="form-group">';
                                    echo '<label>Buyer Price</label>';
									echo '<input type="text" name="ticker" class="form-control" value="'.$_SESSION['buyerPrice'].'" readonly>';
                                    echo '</div>';
                                    echo '</div>';
									
									echo '<div class="col-sm-6">';
                                    echo ' <div class="form-group">';
                                    echo '<label>Buyer Volume</label>';
									echo '<input type="text" name="ticker" class="form-control" value="'.$_SESSION['buyervolume'].'" readonly>';
                                    echo '</div>';
                                    echo '</div>';*/
                                	$i++;
								}
								...
								<p class="text-center">
									<?php
										echo '<a href="bidsDetails.php" class="btn btn-template-main">Go back!</a>';
									?>
								</p>
