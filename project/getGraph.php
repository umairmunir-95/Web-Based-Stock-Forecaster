                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="marketSumary.php">Market Summary</a>
                                                            </li>
        ...
        <div id="content">
            <div class="container">
			 ...
			 _________________________________________________________ -->
					...
					<h4 style="margin-left:20px;"><strong>Please select a Company to view Graph!!!</strong></h4>
							<?php
								...
								echo "<form action='getGraphImage.php' method='GET'>";
								echo "<body>";
								...
								echo "</select>";
								echo '<br><br>';
								echo "<input type='submit' value='Submit' class='btn btn-small btn-template-main'>";
								echo "</form>";
