...
$result1 = mysql_query("SELECT * FROM companies ORDER BY ID ASC");
	function deleteType()
	{
		$id = $_GET['id'];
                        ...
                        <div class="panel panel-default sidebar-menu with-icons">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active"><a href="adminPortfolio.php">Registered Companies</a>
                                    </li>
                                    <li><a href="viewUsers.php">Registered Users</a>
                                    </li>
                                    <li><a href="addCompany.php">Add Companies</a>
                                    </li>
					 ...
					 <h3>Registered Companies </h3> 
                        ...
                        <div class="tabs">
                            <ul class="nav nav-pills nav-justified">
                                <li class=""><a href="#tab2-1" data-toggle="tab">View Registered Companies!! </a>
                                </li>
								</li>
								<li class=""><a href="#tab2-2" data-toggle="tab">View Companies Categories </a>
                                </li>
										...
										<tbody>
										  ...
										  <?php
											$i=0;
												...
												<td><?php echo number_format(($row1["Stock"]),2); ?></td>
												<td><?php echo number_format(($row1["Price"]),2); ?></td>
												<td><?php echo $row1["Email"]; ?></td>
												<td><?php echo $row1["Phone"]; ?></td>
												<td><a href="deleteCompany.php?id=<?php echo $row1["ID"] ; ?>" class="link"><?php echo "Delete"; ?></a></td>
												</tr>
												<?php
												$i++;
												}
								...
								<div class="tab-pane" id="tab2-2">
                                    <p>
										...
										<tbody>
										  ...
										  <?php
											$i=0;
											$result = mysql_query("SELECT * FROM companytype ORDER BY ID ASC");
												while($row2 = mysql_fetch_array($result)) {
												?>
												<td><?php echo $row2["ID"]; ?></td>
												<td><?php echo $row2["Type"]; ?></td>
												<td><a href="deleteCompanyType.php?id=<?php echo $row2["ID"] ; ?>" class="link"><?php echo "Delete"; ?></a></td>
