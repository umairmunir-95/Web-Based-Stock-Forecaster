...
include ("includes/connect.php");
		...
		{
			$ticker=$_POST['type'];
			$result1 = mysql_query("SELECT * FROM transactions where ticker='".$ticker."'");
			$result2 = mysql_query("SELECT * FROM transactions where transactionType='buy' && ticker='".$ticker."'");
			$result3 = mysql_query("SELECT * FROM transactions where transactionType='sell' && ticker='".$ticker."'");
	    }
...
_________________________________________________________ -->
 ...
 _________________________________________________________ -->
                        ...
                        <div class="panel panel-default sidebar-menu with-icons">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active"><a href="template-accordions.html">Trading Screen</a>
                                    </li>
                                    <li><a href="marketSummary.php">Market Summary</a>
                                    </li>
                                    <li><a href="allServices.php">All Services</a>
					...
					<h3>Please select a Company!</h3>
					 <form action="marketTrends.php" method="post">
					...
					<!-- /.row -->
                        ...
                        <div class="tabs">
                            <ul class="nav nav-pills nav-justified">
                                <li class=""><a href="#tab2-1" data-toggle="tab">Selling</a>
                                </li>
                                <li class=""><a href="#tab2-2" data-toggle="tab">Buying</a>
                                </li>
                                <li class="active"><a href="#tab2-3" data-toggle="tab">All</a>
                                </li>
                            </ul>
										...
										<tbody>
										  ...
										  <?php
											...
											if(isSet($_POST['type']))
											{
												...
												<td><?php echo $row3["ticker"]; ?></td>
												<td><?php echo $row3["volume"]; ?></td>
												<td><?php echo $row3["price"]; ?></td>
												<td><?php echo $row3["transactionType"]; ?></td>
												<td><?php echo $row3["transactionTime"]; ?></td>
												</tr>
												<?php
												$i++;
												}
										...
										<tbody>
										  ...
										  <?php
											...
											if(isSet($_POST['type']))
											{
												...
												<td><?php echo $row2["transactionType"]; ?></td>
												<td><?php echo $row2["transactionTime"]; ?></td>
												</tr>
												<?php
												$i++;
												}
