                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="portfolio-no-space-2.html">Get Next Day Prediction</a>
                                                            </li>
            ...
            <div class="container">
			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-order">
							 ...
							 <h4 style="margin-left:20px;"><strong>Please select your choice </strong></h4>
				        <?php
						...
						<form action='getHistoricData.php' method='GET'>
						  ...
						  <br>
						   <input type="submit" value="Submit" class="btn btn-small btn-template-main"/>
						</form>
						<br>
						<form action="stockDownloader.php" method="post">
						<p><input type="submit" name="Submit" value="Refresh" class="btn btn-small btn-template-main" /></p>
						</form>
                        ...
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="getQuotes.php"><i class="fa fa-heart"></i>Get Real Time Quotes</a>
                                    </li>
                                    <li>
                                        <a href="getGraph.php"><i class="fa fa-user"></i> View Graphical Data</a>
                                    </li>
                                </ul>
                            </div>
