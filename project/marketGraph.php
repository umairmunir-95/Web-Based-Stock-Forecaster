...
_________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1>Trading Graphs </h1>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            <li><a href="index.php">Home</a>
                            </li>
                            <li>Trading Graphs</li>
                        </ul>
 ...
 _________________________________________________________ -->
                    ...
                    <div class="col-md-8">
					    ...
					    <section>
                            ...
                            <form action="marketGraphInfo.php" method="GET">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="firstname">Please select a Company</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="lastname">Graph Parameters</label>
					...
					?>
					<br>	
					<p>Customized services and state-of-the-art technology infrastructure, have given us an edge over other exchanges in the region.</p>
					<ul><li>Fully automated trading, clearing and settlement system.</li></ul>
					<ul><li>Internet routed trading facility.</li></ul>
					<ul><li>Gateway trading (Order Management System).</li></ul>
					<ul><li>Investors and fund managers can also access information through Display Only Terminal.</li></ul>
					<ul><li>Internet trading facilities available.</li></ul>
					<ul><li>Order-driven system.</li></ul>
					<!-- /.row -->
