...
$result = mysql_query("SELECT * FROM registration ORDER BY ID ASC");
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="panel panel-default sidebar-menu with-icons">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active"><a href="viewUsers.php">Registered Users</a>
                                    </li>
					 ...
					 <h3>Registered Companies </h3> 
                        ...
                        <div class="tabs">
                            <ul class="nav nav-pills nav-justified">
                                <li class=""><a href="#tab2-1" data-toggle="tab">View Registered Users!! </a>
                                </li>
										...
										<tbody>
										  <?php
											$i=0;
												...
												<td><a href="deleteUser.php?id=<?php echo $row1["ID"] ; ?>" class="link" onClick=\"return confirm('Are you sure you want to delete?')\><?php echo " Delete"; ?></a></td>
												</tr>
												<?php
												$i++;
												}
