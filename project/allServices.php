 ...
 _________________________________________________________ -->
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked category-menu">
                                    <li>
                                        <a>Others <span class="badge pull-right"></span></a>
                                        <ul>
                                            <li><a href="getQuotes.php">Get Quotes</a>
                                            </li>
                                            <li><a href="getPrediction.php">Get Prediction</a>
                                            </li>
											<li><a href="getHistoricData.php">View Historic Data</a>
                                            </li>
                                            <li><a href="getGraph.php">View Graphs</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="active">
                                        <a>About  <span class="badge pull-right"></span></a>
                                        <ul>
                                            <li><a href="404.php">How it works</a>
                                            </li>
                                            <li><a href="404.php">Prediction Techniques</a>
			...
			_________________________________________________________ -->
                    ...
                    <div class="col-sm-9">
                        ...
                        <p class="text-muted lead">These are the list of servies that we provide to our customers in simulation mode.</p>
                        ...
                        <div class="row products">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    <div class="image">
                                        <a href="">
                                            <img src="img/ser5.jpg" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <!-- /.image -->
                                    <div class="text">
                                        <h3><a href="">Real Time Quotes</a></h3>
                                        <p class="buttons">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    <div class="image">
                                        <a href="">
                                            <img src="img/ser1.jpg" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <!-- /.image -->
                                    <div class="text">
                                        <h3><a href="">Next Day Prediction</a></h3>
                                        <p class="buttons">
                                            <a href="" class="btn btn-default">View detail</a>
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    <div class="image">
                                        <a href="">
                                            <img src="img/ser3.jpg" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <!-- /.image -->
                                    <div class="text">
                                        <h3><a href="">Graphical View of all transactions</a></h3>
                                        <p class="buttons">
                                            <a href="" class="btn btn-default">View detail</a>
                                        </p>
